...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo e($profile->universityname); ?>'s Profile
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-center"><?php echo e($profile->universityname); ?></h3>

              <p class="text-muted text-center">University</p>
                ...
                <div class="active tab-pane" id="activity">
                  <table class="table">
                    <tr>
                      ...
                      <td><h5><?php echo e($profile->universityname); ?></h5></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td><h5>Address:</h5></td>
                      <td><h5><?php echo e($profile->address); ?></h5></td>
                    </tr>
                    <tr>
                      <td><h5>City:</h5></td>
                      <td><h5><?php echo e($profile->addresscity); ?></h5></td>
                    </tr>
                  </table>
                </div>
                <!-- /.tab-pane -->
