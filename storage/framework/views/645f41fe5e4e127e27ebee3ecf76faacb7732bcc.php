        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo e(Auth::user()->donorname); ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo e(Auth::user()->donorname); ?>
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo e(route('donor.logout')); ?>"
                     onclick="event.preventDefault();
                                   document.getElementById('logout-form').submit();" class="btn btn-default btn-flat">Sign out</a>
                  <form id="logout-form" action="<?php echo e(route('donor.logout')); ?>" method="POST" style="display: none;">
                      <?php echo csrf_field(); ?>
                  </form>
                </div>
              </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php echo e(Request::is('donor') ? 'active' : ''); ?>">
          <a href="<?php echo e(route('donor.index')); ?>">
            <i class="fa fa-dashboard"></i> <span>Dashboard</span>
          </a>
        </li>

        <li class="<?php echo e(Request::is('donor/students') ? 'active' : ''); ?>">
          <a href="<?php echo e(route('donor.students.index')); ?>">
            <i class="fa fa-files-o"></i>
            <span>Open Applications</span>
          </a>
        </li>

        <li class="<?php echo e(Request::is('donor/students/accepted') ? 'active' : ''); ?>">
          <a href="<?php echo e(route('donor.students.accepted')); ?>">
            <i class="fa fa-file-o"></i>
            <span>Accepted Applications</span>
          </a>
        </li>

        <li class="<?php echo e(Request::is('donor/students/upload') ? 'active' : ''); ?>">
          <a href="<?php echo e(route('donor.students.upload')); ?>">
            <i class="fa fa-file-o"></i>
            <span>Upload Beneficiaries</span>
          </a>
        </li>

        <li class="<?php echo e(Request::is('donor/donor/*') ? 'active' : ''); ?>">
          <a href="<?php echo e(route('donor.show', Auth::user()->id)); ?>">
