  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php echo e(Request::is('admin/donors') ? 'active' : ''); ?>">
        ...
        <li class="<?php echo e(Request::is('admin/universities') ? 'active' : ''); ?>">
        ...
        <li class="<?php echo e(Request::is('admin/banks') ? 'active' : ''); ?>">
        ...
        <li class="<?php echo e(Request::is('admin/wallet') ? 'active' : ''); ?>">
