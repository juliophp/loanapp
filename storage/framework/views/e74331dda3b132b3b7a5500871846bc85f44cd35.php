          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo e(route('bank.banks.show', Auth::user()->id)); ?>" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo e(route('logout')); ?>"
                     onclick="event.preventDefault();
                                   document.getElementById('logout-form').submit();" class="btn btn-default btn-flat">Sign out</a>
                  <form id="logout-form" action="<?php echo e(route('bank.logout')); ?>" method="POST" style="display: none;">
                      <?php echo csrf_field(); ?>
                  </form>
                </div>
              </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php echo e(Request::is('bank') ? 'active' : ''); ?>">
          <a href="<?php echo e(route('bank.index')); ?>">
            <i class="fa fa-dashboard"></i> <span>Dashboard</span>
          </a>
        </li>

        <li class="<?php echo e(Request::is('bank/loans') ? 'active' : ''); ?>">
          <a href="<?php echo e(route('bank.loans.index')); ?>">
            <i class="fa fa-files-o"></i>
            <span>All Loans</span>
          </a>
        </li>

        <li class="<?php echo e(Request::is('bank/loans/granted') ? 'active' : ''); ?>">
        ...
        <li class="<?php echo e(Request::is('banks/*') ? 'active' : ''); ?>">
          <a href="<?php echo e(route('bank.banks.show', Auth::user()->id)); ?>">
        ...
        <li><a href="#"><i class="fa fa-circle-o text-red"></i> <span>
          <?php if(Auth::user()->balances->count() > 0): ?>
            #<?php echo e(number_format(Auth::user()->balances->last()->balance,2)); ?>

          <?php else: ?>
            <?php echo e('No Balance'); ?>
