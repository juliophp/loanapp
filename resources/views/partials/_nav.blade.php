  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview {{ Request::is('bank/wallet/*') ? 'active' : '' }}">
          <a href="">
          ...
          <ul class="treeview-menu">
            <li class="{{ Request::is('bank/wallet/username') ? 'active' : '' }}"><a href="{{ route('bank.wallet.username')}}"><i class="fa fa-circle-o"></i> Wallet Login</a></li>
            <li class="{{ Request::is('bank/wallet/statement') ? 'active' : '' }}"><a href="{{ route('bank.wallet.statement')}}"><i class="fa fa-circle-o"></i> Your Statement</a></li>
            <li class="{{ Request::is('bank/wallet/fundtransfer') ? 'active' : '' }}"><a href="{{ route('bank.wallet.fundtransfer')}}"><i class="fa fa-circle-o"></i> Fund Transfer</a></li>
