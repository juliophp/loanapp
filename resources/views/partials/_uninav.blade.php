        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">{{ Auth::user()->universityname }}</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  ...
                  <form id="logout-form" action="{{ route('uni.logout') }}" method="POST" style="display: none;">
                      @csrf
                  </form>
                </div>
              </li>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="{{ Request::is('university') ? 'active' : '' }}">
          <a href="{{ route('uni.index')}}">
            <i class="fa fa-dashboard"></i> <span>Dashboard</span>
          </a>
        </li>

        <li class="{{ Request::is('university/students') ? 'active' : '' }}">
          <a href="{{ route('uni.students.index')}}">
            <i class="fa fa-files-o"></i>
            <span>Review Profile</span>
          </a>
        </li>

        <li class="{{ Request::is('university/students/reviewed') ? 'active' : '' }}">
          <a href="{{ route('uni.students.reviewed')}}">
